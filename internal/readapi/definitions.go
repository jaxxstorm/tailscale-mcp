...
func MutatingEndpoints() []Endpoint {
	return []Endpoint{
		...
		{OperationID: "setDnsNameservers", ToolName: "tailscale_set_dns_nameservers", Summary: "Replace DNS nameservers", Method: "POST", Path: "/tailnet/{tailnet}/dns/nameservers", Body: true, Idempotent: Bool(true), Confirm: "setDnsNameservers"},
		{OperationID: "setDnsPreferences", ToolName: "tailscale_set_dns_preferences", Summary: "Set DNS preferences", Method: "POST", Path: "/tailnet/{tailnet}/dns/preferences", Body: true, Idempotent: Bool(true), Confirm: "setDnsPreferences"},
		{OperationID: "setDnsSearchPaths", ToolName: "tailscale_set_dns_search_paths", Summary: "Replace DNS search paths", Method: "POST", Path: "/tailnet/{tailnet}/dns/searchpaths", Body: true, Idempotent: Bool(true), Confirm: "setDnsSearchPaths"},
		...
		{OperationID: "setCustomDevicePostureAttributes", ToolName: "tailscale_set_custom_device_posture_attributes", Summary: "Set a custom device posture attribute", Method: "POST", Path: "/device/{deviceId}/attributes/{attributeKey}", Parameters: []Parameter{RequiredPath("deviceId", "Device ID"), RequiredPath("attributeKey", "Attribute key")}, Body: true, Idempotent: Bool(true), Confirm: "setCustomDevicePostureAttributes"},
		{OperationID: "authorizeDevice", ToolName: "tailscale_authorize_device", Summary: "Authorize or deauthorize a device", Method: "POST", Path: "/device/{deviceId}/authorized", Parameters: []Parameter{RequiredPath("deviceId", "Device ID")}, Body: true, Destructive: true, Idempotent: Bool(true), Confirm: "authorizeDevice"},
		{OperationID: "expireDeviceKey", ToolName: "tailscale_expire_device_key", Summary: "Expire a device key", Method: "POST", Path: "/device/{deviceId}/expire", Parameters: []Parameter{RequiredPath("deviceId", "Device ID")}, Destructive: true, Idempotent: Bool(true), Confirm: "expireDeviceKey"},
		{OperationID: "setDeviceIp", ToolName: "tailscale_set_device_ip", Summary: "Set a device IPv4 address", Method: "POST", Path: "/device/{deviceId}/ip", Parameters: []Parameter{RequiredPath("deviceId", "Device ID")}, Body: true, Idempotent: Bool(true), Confirm: "setDeviceIp"},
		...
		{OperationID: "setDeviceName", ToolName: "tailscale_set_device_name", Summary: "Set device name", Method: "POST", Path: "/device/{deviceId}/name", Parameters: []Parameter{RequiredPath("deviceId", "Device ID")}, Body: true, Idempotent: Bool(true), Confirm: "setDeviceName"},
		{OperationID: "setDeviceRoutes", ToolName: "tailscale_set_device_routes", Summary: "Set enabled device routes", Method: "POST", Path: "/device/{deviceId}/routes", Parameters: []Parameter{RequiredPath("deviceId", "Device ID")}, Body: true, Idempotent: Bool(true), Confirm: "setDeviceRoutes"},
		{OperationID: "setDeviceTags", ToolName: "tailscale_set_device_tags", Summary: "Set device tags", Method: "POST", Path: "/device/{deviceId}/tags", Parameters: []Parameter{RequiredPath("deviceId", "Device ID")}, Body: true, Idempotent: Bool(true), Confirm: "setDeviceTags"},
		...
		{OperationID: "getAwsExternalId", ToolName: "tailscale_get_aws_external_id", Summary: "Create or get an AWS external ID for log streaming", Method: "POST", Path: "/tailnet/{tailnet}/aws-external-id", Body: true, Idempotent: Bool(true), Confirm: "getAwsExternalId"},
		...
		{OperationID: "setPolicyFile", ToolName: "tailscale_set_policy_file", Summary: "Set the tailnet policy file", Method: "POST", Path: "/tailnet/{tailnet}/acl", Body: true, Idempotent: Bool(true), Confirm: "setPolicyFile"},
		...
		{OperationID: "deleteUser", ToolName: "tailscale_delete_user", Summary: "Delete a user", Method: "POST", Path: "/users/{userId}/delete", Parameters: []Parameter{RequiredPath("userId", "User ID")}, Destructive: true, Idempotent: Bool(true), Confirm: "deleteUser"},
		...
		{OperationID: "suspendUser", ToolName: "tailscale_suspend_user", Summary: "Suspend a user", Method: "POST", Path: "/users/{userId}/suspend", Parameters: []Parameter{RequiredPath("userId", "User ID")}, Destructive: true, Idempotent: Bool(true), Confirm: "suspendUser"},
		...
		{OperationID: "rotateWebhookSecret", ToolName: "tailscale_rotate_webhook_secret", Summary: "Rotate a webhook secret", Method: "POST", Path: "/webhooks/{endpointId}/rotate", Parameters: []Parameter{RequiredPath("endpointId", "Webhook endpoint ID")}, Destructive: true, Confirm: "rotateWebhookSecret"},
